...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class('row align-items-start  justify-content-center', $product); ?>>
    ...
    <div class="entry-summary col-lg-7 d-flex flex-wrap justify-content-center align-items-start px-0">
        ...
        <div class="row col-12 col-lg-5 bg-white rounded-4 align-self-start p-4" data-aos="fade-right">
            ...
            <div class="d-flex align-items-center py-2 px-0 border-bottom border-info">
                <div class="col-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M3.01001 11.22V15.71C3.01001 20.2 4.81001 22 9.30001 22H14.69C19.18 22 20.98 20.2 20.98 15.71V11.22"
            ...
            ?>
            <a href="tel:<?= $phone; ?>" class="d-flex align-items-center py-2 px-0 border-bottom border-info">
                <div class="col-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M18.5 9C18.5 8.4 18.03 7.48 17.33 6.73C16.69 6.04 15.84 5.5 15 5.5" stroke="#292D32"
                              stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M22 9C22 5.13 18.87 2 15 2" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"/>
                    </svg>
                </div>
                <div>
                    <span>شماره تماس</span>
                    <p class="text-dark text-opacity-75 mb-0"><?= $phone; ?></p>
                </div>
            </a>
            <?php
            //              }
            ...
            <a href="mailto:<?= $email; ?>" class="d-flex align-items-center py-2 px-0 border-bottom border-info">
                <div class="col-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="row">
                    <span>ایمیل</span>
                    <p class="text-dark text-opacity-75 mb-0"><?= $email; ?></p>
                </div>
            </a>
            <!--            --><?php // } ?>
            <?php
...
//            var_dump($galleryFile['url']);
            // Check if the repeater field has rows
            if ($galleryFile) {
                    // Output the card HTML with the repeater field values
                    ?>
                    <a href="<?= $galleryFile['url']; ?>" download
                       class="d-flex align-items-center py-2 px-0 border-bottom border-info">
                        <div class="col-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path d="M21 7V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V7C3 4 4.5 2 8 2H16C19.5 2 21 4 21 7Z"
                                      stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M14.5 4.5V6.5C14.5 7.6 15.4 8.5 16.5 8.5H18.5" stroke="#292D32"
                                      stroke-width="1.5"
                                      stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8 13H12" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8 17H16" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="row">
