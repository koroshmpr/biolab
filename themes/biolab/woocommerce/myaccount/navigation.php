...
<nav class="woocommerce-MyAccount-navigation vh-100 ps-lg-5 row align-items-center">
	<ul class="list-group list-group-item list-group-item-action align-items-center border-0 bg-white">
