 ...
 */
?>
<header class="dokan-dashboard-header p-lg-5 d-flex p-3 text-white">
    <div class="dokan-store-settign-header-wrap">
        <h1 class="entry-title">
            <?php echo wp_kses_post( $heading ); ?>
            <small>&rarr; <a class="text-success ps-2" href="<?php echo esc_url( dokan_get_store_url( dokan_get_current_user_id() ) ); ?>"><?php esc_html_e( 'Visit Store', 'dokan-lite' ); ?></a></small>
        </h1>
    </div>
