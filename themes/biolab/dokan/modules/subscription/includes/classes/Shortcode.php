...
class Shortcode {
    ...
    public static function create_subscription_package_shortcode() {
        ...
        <div class="dokan-subscription-content bg-danger">
            <?php
                                ...
                                <div class="pack_data_option">
                                    ...
                                    <?php
                                        ...
                                        if ( empty( $sub_pack->get_pack_valid_days() ) ) {
                                            echo sprintf( '%1$s<br /><strong>%2$s</strong> %3$s', __( 'For', 'dokan' ), __( 'Unlimited', 'dokan' ), __( 'Day', 'dokan' ) );
                                        } else {
                                            $pack_validity = $sub_pack->get_pack_valid_days();
                                            echo sprintf( '%1$s<br /><strong>%2$s</strong> %3$s', __( 'For', 'dokan' ), $pack_validity, __( 'Day', 'dokan' ) );
                                        }
                                    endif;
                                    ?>
