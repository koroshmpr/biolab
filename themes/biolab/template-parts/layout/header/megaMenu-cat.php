                        ...
                        <div class="row gap-1 p-lg-4">
                            ...
                            if ($subcategories) {
                                foreach ($subcategories as $sub_cat) {
                                    ...
                                    ?>
                                    <a class="mb-lg-3 mb-4 border-start border-3 border-success ps-2 bg-info bg-opacity-10 text-dark text-opacity-75"
                                    ...
                                    if ($sub_subcategories) {
                                        foreach ($sub_subcategories as $sub_sub_cat) {
                                            ?>
                                            <a class="ps-3 row row-cols-2 row-cols-lg-6 align-items-center "
                                               href="<?= get_term_link($sub_sub_cat); ?>">
                                                <div class="p-2 text-opacity-75 hover_text-primary"><?= $sub_sub_cat->name; ?></div>
                                            </a>
                                            <?php
                                        }
                                    }
