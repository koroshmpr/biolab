...
<div class="col-11 col-lg-12 category-dropdown dropdown-menu container mt-n2 py-0 pb-4 overflow-hidden"
    ...
    <div class="container">
        <div class="row justify-content-start">
            <div class="col-lg-3 px-0">
                <nav id="myTab" class="nav nav-pills flex-nowrap vh-lg-80 flex-row flex-lg-column list-group border-end border-1 border-info overflow-scroll">
                    <?php
            ...
            <div class="col-lg-9 tab-content p-lg-3 p-4 overflow-scroll" style="height: 80vh;">
                <?php
                foreach ($parent_categories as $key => $parent_cat) {
                    $thumbnail_id = get_term_meta($parent_cat->term_id, 'thumbnail_id', true); ?>
                        ...
                        <div class="row gap-2 p-lg-4 overflow-y-scroll align-items-start h-auto">
                            ...
                            if ($subcategories) {
                                foreach ($subcategories as $sub_cat) {
                                    ...
                                    ?>
                                    <a class="border-start border-3 border-success ps-2 bg-info bg-opacity-10 text-dark"
                                        ...
                                        foreach ($sub_subcategories as $sub_sub_cat) {
                                            ...
                                            <a class="ps-3 row align-items-start"
                                               href="<?= get_term_link($sub_sub_cat); ?>">
                                                <div class="border-start border-success border-opacity-50 border-2 text-dark text-opacity-75"><?= $sub_sub_cat->name; ?></div>
                                            </a>
                                            <?php
                                        }
                                    }
