<button class="btn btn-white rounded-4 category-dropdown__button py-1 fw-bold" type="button" data-bs-toggle="dropdown" data-bs-auto-close="false" aria-expanded="false">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mx-2 bi bi-list" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
    </svg>
    دسته‌بندی
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mx-2 bi bi-chevron-down" viewBox="0 0 16 16">
    ...
    <div class="container">
        <div class="row justify-content-start">
            <div class="col-lg-2 px-0">
                <nav id="myTab" class="nav nav-pills flex-nowrap flex-row flex-lg-column list-group border-end border-1 border-info overflow-x-scroll">
                    <?php
                    if ($children) {
