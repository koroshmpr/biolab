<div class="d-flex justify-content-center my-3 <?= $args['containerCLass'] ?? '';?>">
    <div class="col-12 col-lg-10 <?= $args['mainClass'] ?? 'd-grid d-lg-flex';?> gap-2 justify-content-center align-items-center">
        ...
        ?>
        <ul class="d-flex list-unstyled gap-2 m-0 align-items-center overflow-hidden justify-content-center p-3 <?= $args['class'] ?? '';?> ">
            <li data-aos="fade-up" data-aos-duration="500">
                <a aria-label="share-in-aparat" class="bg-white shadow-sm <?= $args['linkClass'] ?? 'px-2 py-1 rounded-circle';?>"
            ...
            <li data-aos="fade-up" data-aos-delay="100" data-aos-duration="500">
                <a  aria-label="share-in-telegram" class="bg-white shadow-sm <?= $args['linkClass'] ?? 'px-2 py-1 rounded-circle';?>"
            ...
            <li data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
                <a aria-label="share-in-youtube" class="bg-white shadow-sm <?= $args['linkClass'] ?? 'px-2 py-1 rounded-circle';?>"
            ...
            <li data-aos="fade-up" data-aos-delay="300" data-aos-duration="500">
                <a  aria-label="share-in-instagram" class="bg-white shadow-sm <?= $args['linkClass'] ?? 'px-2 py-1 rounded-circle';?>"
            ...
            <li data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">
                <a aria-label="share-in-twitter" class="bg-white shadow-sm <?= $args['linkClass'] ?? 'px-2 py-1 rounded-circle';?>"
            ...
            <li data-aos="fade-up" data-aos-delay="500" data-aos-duration="500">
                <a aria-label="share-in-linkedin" class="bg-white shadow-sm <?= $args['linkClass'] ?? 'px-2 py-1 rounded-circle';?>"
