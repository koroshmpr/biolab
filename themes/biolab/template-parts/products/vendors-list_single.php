<div class="text-start w-100 mt-lg-5 mt-2 p-lg-4 rounded-3 border border-info border-opacity-50">
    <div class="border-bottom border-info border-opacity-50 d-flex my-2">
        <h6 class="border-bottom text-secondary border-success mb-0 pb-3 border-2 fw-bold fs-4">سایر فروشندگان موجود</h6>
    </div>
    <div class="row">
        <div class="d-flex align-items-center border-bottom border-info p-3">
            <div class="me-3">
